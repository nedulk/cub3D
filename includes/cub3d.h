...
int					draw_door(t_vars *vars, double distance_to_wall, int x,
						int j);
...
int					draw_north_wall(t_vars *vars, double distance_to_wall,
						int x, int j);
int					draw_south_wall(t_vars *vars, double distance_to_wall,
						int x, int j);
int					draw_east_wall(t_vars *vars, double distance_to_wall, int x,
						int j);
int					draw_west_wall(t_vars *vars, double distance_to_wall, int x,
						int j);
int					draw_door(t_vars *vars, double distance_to_wall, int x,
						int j);
...
// Drawing first iteration of the image
